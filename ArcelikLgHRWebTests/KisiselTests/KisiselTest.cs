...
namespace ArcelikLgHRWebTests.KisiselTests
{
    ...
    public class KisiselTest
    {
        ...
        [Owner("Eda Ekiz")]
        [Description("Kullanıcıya ait kişisel bilgilerin güncellenme işleminin doğru gerçekleşip gerçekleşmediğinin kontrolünün yapıldığı testtir.")]
        [TestMethod]
        public void PersonalInformation_Update()
        {
            ...
            var NewPersonal = personalMock.FirstOrDefault(X => X.UserInfoId == personalInfo.PersonalID);
