...
{
    public static class TrnEncryption
    {
        #region Consts
        /// <summary>
        ...
        public static string encrypt(string text, string salt, string inputKey)
        {
        ...
        public static string decrypt(string cipherText, string salt, string inputKey)
        {
